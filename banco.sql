...
INSERT INTO `cursos` VALUES (1,'Introdução ao Uso de Computadores','https://s2-techtudo.glbimg.com/8rng1sV5afk_6WZRli1PKTvoy7w=/0x0:1500x1000/984x0/smart/filters:strip_icc()/i.s3.glbimg.com/v1/AUTH_08fbf48bc0524877943fe86e43087e7a/internal_photos/bs/2019/n/R/kdN4P7SNuOq8mq7CUo8Q/techtudo-banner.jpg','<p>Este <strong>curso introdutório</strong> é ideal para quem deseja aprender os conceitos básicos de informática. Ele abrange tópicos essenciais como:</p>\n<ul>\n  <li>Entendimento do <em>hardware</em> e <em>software</em> de um computador.</li>\n  <li>Uso de sistemas operacionais como Windows e Linux.</li>\n  <li>Noções de segurança digital.</li>\n  <li>Práticas de navegação na internet e uso de e-mails.</li>\n</ul>\n<p>Ao final do curso, o aluno estará apto a utilizar o computador com mais confiança e eficiência no dia a dia.</p>');
...
-- Dump completed on 2024-09-04 21:38:32
